...
export declare class RelayAdaptVersionedSmartContracts {
    ...
    static populateRelayWithActionData(txidVersion: TXIDVersion, chain: Chain, transactions: TransactionStructV2[], actionData: RelayAdaptActionData): Promise<ContractTransaction>;
